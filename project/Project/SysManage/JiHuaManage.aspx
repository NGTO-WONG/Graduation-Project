<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JiHuaManage.aspx.cs" Inherits="Project.SysManage.JiHuaManage" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-md-12 role_content_right">
                <div class="main_head">
                    <div class="pull-left padding_right_15">
                        <div class="title_box"><b>报销计划制定信息</b></div>
                    </div>
                    <div class="pull-left padding_left_15 ">
                        <asp:TextBox ID="txtKey" runat="server" CssClass="input_text" placeholder="可查找项目/制定人"></asp:TextBox>
                        <asp:Button ID="btnSearch" runat="server" CssClass="" OnClick="btnSearch_Click" Text="搜索信息" />
                    </div>
                    <div class="pull-right">
                        <button type="button" class="" onclick="method5('tableExcel')"> 导出EXCEL </button>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <%if (mbGrade == 1)
                              { %>
                            <td>
                                <a href="JiHuaOper.aspx?id=<%#Eval("Id") %>"><span class="blue">审核</span></a>&nbsp;
